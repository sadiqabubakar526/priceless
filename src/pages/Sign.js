...
import facebookSign from './components/FacebookSign.png'
    ...
    return (
        <div className="sign-page">
            <div className="sign-components">
                <div className="brand-name">SAUQ</div>
                <div className="signOptions">
                    <img className="googleSign" src={googleSign} onClick={logInWithGoogle} />
                    <img className="facebookSign" src={facebookSign} onClick={logInWithFacebook} />
