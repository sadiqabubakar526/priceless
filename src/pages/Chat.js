...
let firebaseProfilesRef = firebase.database().ref("Sauq Engine/Profiles");
let firebaseMessagingRef = firebase.database().ref("Sauq Engine/User-Garbage");
...
function Chat(props) {
    ...
    function sendImg(e) {
        ...
        const storageRef = firebase.storage().ref("Sauq/User-Shit/" + chatServer + fileName);
        storageRef
